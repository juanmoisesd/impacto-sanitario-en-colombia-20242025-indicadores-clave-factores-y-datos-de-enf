# Impacto Sanitario en Colombia (2024–2025): Indicadores Clave, Factores y Datos de Enfermedades
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18949409.svg)](https://doi.org/10.5281/zenodo.18949409)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/impacto-sanitario-en-colombia-20242025-indicadores-clave-factores-y-datos-de-enf/)

## Overview
Esta base de datos recopila indicadores clave de salud, datos de brotes de enfermedades, tasas de vacunación, estado del sistema de salud, seguridad alimentaria y los principales factores que influyen en la salud pública en Colombia durante 2024–2025. Datos obtenidos de Perplexity.ai, con cita de OMS/OPS, OCDE, HRW, UNICEF, OCHA, MSF, CDC, PMA, CICR, Relief Web y PMC/NIH.

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18949409](https://doi.org/10.5281/zenodo.18949409) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2026-03-05 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/impacto-sanitario-en-colombia-20242025-indicadores-clave-factores-y-datos-de-enf/)**

## Keywords


## Citation
> de la Serna Tuya, J.M. (2026). *Impacto Sanitario en Colombia (2024–2025): Indicadores Clave*. Zenodo. https://doi.org/10.5281/zenodo.18949409
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Esta base de datos recopila indicadores clave de salud, datos de brotes de enfermedades, tasas de vacunación, estado del sistema de salud, seguridad alimentaria y los principales factores que influyen en la salud pública en Colombia durante 2024–2025* [Dataset]. GitHub. https://github.com/juanmoisesd/impacto-sanitario-en-colombia-20242025-indicadores-clave-factores-y-datos-de-enf

**BibTeX**
```bibtex
@dataset{delaserna2025_impacto_sanitario_en_colombia_,
  author    = {De la Serna Tuya, Juan Moisés},
  title     = {Esta base de datos recopila indicadores clave de salud, datos de brotes de enfermedades, tasas de vacunación, estado del sistema de salud, seguridad alimentaria y los principales factores que influyen en la salud pública en Colombia durante 2024–2025},
  year      = {2025},
  publisher = {GitHub},
  url       = {https://github.com/juanmoisesd/impacto-sanitario-en-colombia-20242025-indicadores-clave-factores-y-datos-de-enf},
